...
public class OrderActivityBasicTest {
    ...
    public void clickIncrementButton_ChangesQuantityAndCost(){
        ...
        /* Find the view and perform action on view */
        onView((withId(R.id.increment_button)))
                .perform(click());

        /* Use assertions to check if view does as what's expected */
    ...
    public void clickDecrementButton_ChangesQuantityAndCost(){
        ...
        /* Check if initial quantity is zero */
        ...
        /* Verify decrement button decreased quantity by 1 */
        onView(withId(R.id.quantity_text_view)).check(matches(withText("0")));

        /* Verify increment button also increase total to $5.00 */
